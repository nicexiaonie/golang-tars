...
// This file was generated from UserServerObj.tars
...
// UserServerObj struct
type UserServerObj struct {
	servant model.Servant
}

// NewUserServerObj creates a new UserServerObj servant.
func NewUserServerObj() *UserServerObj {
	return new(UserServerObj)
}

// NewUserServerObjClient creates a new UserServerObj client proxy for the given servant.
func NewUserServerObjClient(servant string, comm *tars.Communicator, option ...tars.EndpointManagerOption) *UserServerObj {
	client := new(UserServerObj)
	comm.StringToProxy(servant, client, option...)
	return client
}

// SetServant sets servant for the service.
func (obj *UserServerObj) SetServant(servant model.Servant) {
	obj.servant = servant
}

// TarsSetTimeout sets the timeout for the servant which is in ms.
func (obj *UserServerObj) TarsSetTimeout(timeout int) {
	obj.servant.TarsSetTimeout(timeout)
}

// TarsSetProtocol sets the protocol for the servant.
func (obj *UserServerObj) TarsSetProtocol(p model.Protocol) {
	obj.servant.TarsSetProtocol(p)
}

// Endpoints returns all active endpoint.Endpoint
func (obj *UserServerObj) Endpoints() []*endpoint.Endpoint {
	return obj.servant.Endpoints()
}

// AddServant adds servant  for the service.
func (obj *UserServerObj) AddServant(imp UserServerObjServant, servant string) {
	tars.AddServant(obj, imp, servant)
}

// AddServantWithContext adds servant  for the service with context.
func (obj *UserServerObj) AddServantWithContext(imp UserServerObjServantWithContext, servant string) {
...
func (obj *UserServerObj) Add(a int32, b int32, c *int32, opts ...map[string]string) (int32, error) {
...
func (obj *UserServerObj) AddWithContext(tarsCtx context.Context, a int32, b int32, c *int32, opts ...map[string]string) (ret int32, err error) {
	var (
		length int32
		have   bool
		ty     byte
...
func (obj *UserServerObj) AddOneWayWithContext(tarsCtx context.Context, a int32, b int32, c *int32, opts ...map[string]string) (ret int32, err error) {
	var (
		length int32
		have   bool
		ty     byte
...
func (obj *UserServerObj) Sub(a int32, b int32, c *int32, opts ...map[string]string) (int32, error) {
...
func (obj *UserServerObj) SubWithContext(tarsCtx context.Context, a int32, b int32, c *int32, opts ...map[string]string) (ret int32, err error) {
	var (
		length int32
		have   bool
		ty     byte
...
func (obj *UserServerObj) SubOneWayWithContext(tarsCtx context.Context, a int32, b int32, c *int32, opts ...map[string]string) (ret int32, err error) {
	var (
		length int32
		have   bool
		ty     byte
...
func (obj *UserServerObj) Dispatch(tarsCtx context.Context, val interface{}, tarsReq *requestf.RequestPacket, tarsResp *requestf.ResponsePacket, withContext bool) (err error) {
	var (
		length int32
		have   bool
		ty     byte
	...
	case "Add":
		...
		var funRet int32
		if !withContext {
			imp := val.(UserServerObjServant)
			funRet, err = imp.Add(a, b, &c)
		} else {
			imp := val.(UserServerObjServantWithContext)
